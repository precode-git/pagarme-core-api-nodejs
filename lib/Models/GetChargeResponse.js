...
class GetChargeResponse extends BaseModel {
    ...
    constructor(obj) {
     ...
     || obj.last_transaction);
        ...
        this.canceledAmount = this.constructor.getValue(obj.canceledAmount || obj.canceled_amount);
     ...
     || obj.recurrency_cycle);
        this.interestAndFinePaid =
          this.constructor.getValue(obj.interestAndFinePaid
     || obj.interest_and_fine_paid);
    }
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'canceledAmount', realName: 'canceled_amount' },
            { name: 'paidAmount', realName: 'paid_amount' },
            { name: 'recurrencyCycle', realName: 'recurrency_cycle' },
            { name: 'interestAndFinePaid', realName: 'interest_and_fine_paid' },
        ]);
    }
