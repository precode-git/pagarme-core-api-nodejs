 ...
 */
class GetTransfer extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'source', realName: 'source', type: 'GetTransferSourceResponse' },
            { name: 'target', realName: 'target', type: 'GetTransferTargetResponse' },
        ]);
    }
