...
class ChargesController {
     ...
     * @returns {Promise}
     */
    static updateChargeCard(chargeId, request, idempotencyKey, callback) {
        ...
        const _headers = {
            ...
            'user-agent': 'PagarmeCoreApi - Node 1.0.0-beta.0',
        };
     ...
     * @returns {Promise}
     */
    static updateChargePaymentMethod(chargeId, request, idempotencyKey, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createCharge(request, idempotencyKey, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static updateChargeMetadata(chargeId, request, idempotencyKey, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static cancelCharge(chargeId, request, idempotencyKey, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static updateChargeDueDate(chargeId, request, idempotencyKey, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static confirmPayment(chargeId, request, idempotencyKey, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
    ...
    static getChargeTransactions(chargeId, page, size, callback) {
        ...
        return new Promise((_fulfill, _reject) => {
            _request(_options, (_error, _response, _context) => {
                ...
                .mapObject(parsed, 'ListChargeTransactionsResponse');
                    _callback(null, parsed, _context);
                    _fulfill(parsed);
                } else {
                    errorResponse = _baseController.validateResponse(_context);
