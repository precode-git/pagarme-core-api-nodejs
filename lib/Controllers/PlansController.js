...
class PlansController {
     ...
     * @returns {Promise}
     */
    static createPlanItem(planId, request, idempotencyKey, callback) {
     ...
     * @returns {Promise}
     */
    static updatePlan(planId, request, idempotencyKey, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static updatePlanMetadata(planId, request, idempotencyKey, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
